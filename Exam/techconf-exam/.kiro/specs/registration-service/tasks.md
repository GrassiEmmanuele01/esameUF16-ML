...
- [ ] 4. Casi d'uso RegistrationService (regole di business)
...
- [ ] 6. Client HTTP verso le dipendenze
...
- [ ] 7. HTTP: serializzazione, mapping errori e rotte
...
- [ ] 9. Unit test del dominio (RegistrationService)
...
- [ ] 11. Unit test dei client HTTP (responses)
...
- [ ] 12. Unit test HTTP + validazione contratto
...
- [ ] 13. Accettazione (opzionale, richiede services.yaml)
