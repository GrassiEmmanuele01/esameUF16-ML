"""Configurazione dell'event-service.

Letta dall'ambiente. Oltre alle variabili comuni, l'event-service dichiara
``USER_SERVICE_URL`` per la verifica dell'organizzatore verso lo user-service.
"""
